...
function IndonesiaNews() {
    ...
    return (
        <div>
        <h1 className="border-b-4 text-center mx-5 text-text_color font-bold text-[50px] border-line_color">INDONESIA NEWS</h1>
        <div className="grid grid-cols-3 place-items-center">
        {news.map((article, key) => (
            <div className="max-w-sm rounded overflow-hidden shadow-xl p-4 flex flex-col" key={key}>
