    ...
    <nav className='bg-white_color px-[70px] shadow-box_item h-[90px] max-[1000px]:h-16 justify-center items-center flex '>
      <div class="container bg-white_color h-full mx-auto  flex justify-between relative items-center">
        ...
        >
            ...
            <Link to="/"
                className={pathname === "/" ? "borderr_active " : "w-full max-[1000px]:px-3"}>Indonesia</Link>
            </li>
            <li className='h-full flex justify-center items-center borderr '> <Link to="programmer"
                className={pathname === "/programmer" ? "borderr_active" : "w-full max-[1000px]:px-3"}>Progemmer</Link>
            </li>
            <li className='h-full flex justify-center items-center borderr '> <Link to="covid"
                className={pathname === "/covid" ? "borderr_active" : "w-full max-[1000px]:px-3"}>Covid-19</Link>
            </li>
            <li className='h-full flex justify-center items-center borderr '> <Link to="saved"
                className={pathname === "/saved" ? "borderr_active" : "w-full max-[1000px]:px-3"}>Saved</Link>
            </li>
        </ul>
      </div>
    </nav>
